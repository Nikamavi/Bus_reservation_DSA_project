...
void busLists()
{
  ...
  printf("-----------------------------------------------------------------------------------------\n");
    ...
    printf("-----------------------------------------------------------------------------------------\n");
    printf("1\tPurple Travels\t\tNagpur to Pune\t\tRs.1000\t\t07:00 AM\n");
    printf("2\tYuga Travels\t\tAkola To Pune\t\tRs.950\t\t01:30 PM\n");
    printf("3\tSangitam Travels\tYawatmal To Mumbai\tRs.900\t\t03:50 PM\n");
    printf("4\tRachana Travels\t\tPune To Nashik\t\tRs.1000\t\t01:00 AM\n");
    printf("5\tRoyal Travels\t\tAurangabad To Sangli\tRs.950\t\t12:05 AM\n");
    printf("6\tNi3 Travels\t\tAkola to Mumbai\t\tRs.900\t\t09:30 AM\n");
    printf("7\tVineet Travels\t\tMalegaon To Pune\tRs.1000\t\t11:00 PM\n");
    printf("8\tMahalaxmi Travels\tKaranja To Pune\t\tRs.950\t\t08:15 AM\n");
    printf("9\tSara Travels\t\tAmravati To Pune\tRs.900\t\t04:00 PM\n");
  printf("\n");
...
main:
{
  ...
  {
    printf("\n\n====================================================================\n\n");
    printf("\t\t\t\033[1;33mBUS RESERVATION\033[0m\t\t");
    printf("\n\n=====================================================================\n");
    printf("\n====================");
    greenColor();
    printf("  MAIN MENU ");
    resetColor();
    printf("=====================\n\n");
    printf("   \033[1;33m[1]\033[0m VIEW BUS LIST \n\n");
    printf("   \033[1;33m[2]\033[0m BOOK TICKETS\n\n");
    printf("   \033[1;33m[3]\033[0m CANCEL BOOKING\n\n");
    printf("   \033[1;33m[4]\033[0m BUSES SEATS INFO\n\n");
    printf("   \033[1;33m[5]\033[0m RESERVATION INFO\n\n");
